 ...
 * @author luciano
 */
public class XGBostMain {
    final static Logger logger = Logger.getLogger(XGBostMain.class);
    ...
    public double[] getXGBoostEvaluating(String datasetName, int seed, int numFolds) {
        ...
        try {
            ...
            DMatrix trainMat = new DMatrix(Util.DB_DF_PRED + Util.DB_TYPE + Util.SEARCH_TYPE + "/libSVM/"+datasetName+".txt");
            ...
            */
            ...
            java.util.logging.Logger.getLogger(XGBostMain.class.getName()).log(Level.SEVERE, null, ex);
        }
        return metrics;
    }
    ...
    public static void main(String[] args) {
        ...
        XGBostMain xgbm = new XGBostMain();
