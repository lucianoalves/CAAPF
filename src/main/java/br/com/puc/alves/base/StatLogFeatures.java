...
/**
 * Created by alves on 6/2/14.
 */
public final class StatLogFeatures {
    ...
    private final int maxIndex, minIndex, meanIndex, meanClass, minClass, maxClass;


    private int distribuicaoClasses[];
    private final double averageMutualInformation=0, averageGainRatio=0, averageEntropy=0, averageInfoGain=0;
    private final double classEntropy=0;
    private final double equivalentNumberOfAttributes=0;
    private final double NSratio=0;
    ...
    private final List<Integer> nominalIndices;
    private final List<Integer> numericIndices = new ArrayList<>();
    private final String name;



    public StatLogFeatures(Instances dataset, MetaFeatures metaFeatures) throws Exception {
        this.nominalIndices = new ArrayList<>();
        ...
        metaFeatures.setBinaryAttributes(numBinaryAtt);
        metaFeatures.setSkew(averageAttributeSkewness);
        metaFeatures.setKurtosis(averageAttributeKurtosis);
        metaFeatures.setMultipleCorrelation(averageAttributeCorrelation);
        metaFeatures.setsDRatio(SDratio);
    }
    ...
    public void computeContinuousMeasures(Instances dataset){
        ...
        ArrayList<SimpleMatrix> attributeValuesPerClass = new ArrayList<>();
