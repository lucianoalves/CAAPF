...
import static weka.core.converters.AbstractFileSaver.runFileSaver;
import weka.core.converters.ArffLoader;
import weka.core.converters.BatchConverter;
import weka.core.converters.IncrementalConverter;
import static weka.core.converters.Saver.BATCH;
import static weka.core.converters.Saver.INCREMENTAL;
import static weka.core.converters.Saver.NONE;
 ...
 * @author luciano
 */
public class ArffSaver2
  extends AbstractFileSaver
  implements BatchConverter, IncrementalConverter {
    
    final static Logger logger = Logger.getLogger(ArffSaver2.class);
    /*
 ...
 */
  ...
  public void writeBatch() throws IOException {
      ...
      s = s.replace("@attribute bug numeric", "@attribute Class {'1','2'}");
  ...
  public static void main(String[] args) {
    runFileSaver(new ArffSaver2(), args);
  }
}
